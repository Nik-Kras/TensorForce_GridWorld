...
class GridWorld:
        ...
        for row in range(self.world_row):
            ...
            for col in range(self.world_col):
                ...
                # Draw walls, paths and goals
                    ...
                    if self.state_matrix[row, col] == -1: row_string += ' # ' # Wall
                    elif self.state_matrix[row, col] == 0: row_string += ' - ' # Path
                    elif self.state_matrix[row, col] == 1: row_string += ' A '  # Goal 1
                    elif self.state_matrix[row, col] == 2: row_string += ' B '  # Goal 2
                    elif self.state_matrix[row, col] == 3: row_string += ' C '  # Goal 3
                    elif self.state_matrix[row, col] == 4: row_string += ' D '  # Goal 4
    ...
    def step(self, action, action_type="optimal"):
        ...
        if self.state_matrix[self.position[0], self.position[1]] == 0: reward = self.step_cost  # Path
        elif self.state_matrix[self.position[0], self.position[1]] == 1: reward = self.goal_rewards[0]  # Goal 1
        elif self.state_matrix[self.position[0], self.position[1]] == 2: reward = self.goal_rewards[1]  # Goal 2
        elif self.state_matrix[self.position[0], self.position[1]] == 3: reward = self.goal_rewards[2]  # Goal 3
        elif self.state_matrix[self.position[0], self.position[1]] == 4: reward = self.goal_rewards[3]  # Goal 4
